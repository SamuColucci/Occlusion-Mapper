...
# Import della funzione di perdita Focal Loss Neurosimbolica Completa
...
def train_focal_completa_model(epochs=20, batch_size=32, lr=1e-3, checkpoint_path=os.path.join("pesi_modelli", "per_zone_checkpoint_focal_completa.pth")):
    ...
    # Loss Focal Loss Neurosimbolica Completa ed Ottimizzatore AdamW con Scheduler Coseno
